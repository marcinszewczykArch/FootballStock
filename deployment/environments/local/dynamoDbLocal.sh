...
echo "creating playerStatsTable..."
t=$(aws dynamodb create-table --cli-input-json file://tables/playerStatsTable.json --endpoint-url http://localhost:8000 2>&1)
if  [ $? = "0" ]; then
    printf "\033[0;32mdone!\033[0m\n"
else
    printf "\033[0;31m$t\033[0m\n"
...
t=$(aws dynamodb create-table --cli-input-json file://tables/clubPlayersTable.json --endpoint-url http://localhost:8000 2>&1)
if  [ $? = "0" ]; then
    printf "\033[0;32mdone!\033[0m\n"
else
    printf "\033[0;31m$t\033[0m\n"
